...
Func _langStrings()
	...
	_AutoItObject_AddProperty($oToolbar, "addRoute")
	...
	_AutoItObject_AddProperty($oToolbar, "addRoute_tip")
...
Func _setLangStrings($langCode = "en-US", $manualUpdate = False)
	...
	$oLangStrings.toolbar.addRoute = Json_Get($jsonData, ".strings.toolbar.addRoute")
	...
	$oLangStrings.toolbar.addRoute_tip = Json_Get($jsonData, ".strings.toolbar.addRoute_tip")
